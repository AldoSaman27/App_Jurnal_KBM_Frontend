...
const generateHTML = ({ foto, name, nip, mapel, jurnal, semester, tahunPelajaran, mengampuhDi }) => {
    const jurnalRows = jurnal.map((item, index) => {
        ...
        return `
            <tr key="${index}">
                ...
                <td><img src="${process.env.EXPO_PUBLIC_API_URL}/uploads/foto_kegiatan/${item.foto_kegiatan}" alt="" width="200" height="115" style="object-fit: cover;"></td>
            </tr>
        `;
    }).join("");
    ...
    return `
        ...
        <body>
            ...
            <div class="d-flex gap-4">
                <img src="${process.env.EXPO_PUBLIC_API_URL}/uploads/foto/${foto || "User_Profile.png"}" alt="" class="rounded-circle border border-5 border-primary" style="width: 200px; height: 200px; object-fit: cover; aspect-ratio: 1 / 1;">
                <table>
                    <tbody>
                        <tr>
...
const generatePdf = async (foto, name, nip, mapel, jurnal, semester, tahunPelajaran, mengampuhDi) => {
    try {
